package refaccionaria.swing.titlebar;
...
public class ComponentResizer extends MouseAdapter {
   ...
   /* public Dimension getMaximumSize() {
    ...
    protected void changeBounds(Component source, int direction, Rectangle bounds, Point pressed, Point current) {
      ...
      /*  if (WEST == (direction & WEST)) {
           ...
           // int maximum = Math.min(width + x, maximumSize.width);
            drag = getDragBounded(drag, snapSize.width, width, minimumSize.width);
            x -= drag;
            width += drag;
        }*
      ...
      /*  if (NORTH == (direction & NORTH)) {
           ...
           //int maximum = Math.min(height + y, maximumSize.height);
            drag = getDragBounded(drag, snapSize.height, height, minimumSize.height);
            y -= drag;
            height += drag;
        }*/
    ...
    private int getDragBounded(int drag, int snapSize, int dimension, int minimum) {
