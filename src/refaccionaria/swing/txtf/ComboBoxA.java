...
import refaccionaria.swing.scroll.*;

public class ComboBoxA<E> extends JComboBox<E> {
    ...
    public ComboBoxA() {
     ...
     private class ComboUI extends BasicComboBoxUI {
        ...
        private ComboBoxA combo;

        public ComboUI(ComboBoxA combo) {
            this.combo = combo;
            ...
            addPopupMenuListener(new PopupMenuListener() {
                ...
                public void popupMenuWillBecomeVisible(PopupMenuEvent pme) {
                    arrowButton.setBackground(new Color(130, 130, 130));
                }

                @Override
                public void popupMenuWillBecomeInvisible(PopupMenuEvent pme) {
                    arrowButton.setBackground(new Color(92, 92, 92));
                }
